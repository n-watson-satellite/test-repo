...
class VisualComponent extends BaseComponent {
	...
	/**
     * Allows to modify the JsonLd content for a given view.
     * @param {string} view_id The identifier of the view of the current component to which the JsonLd will be modified.
     * @param {Function} callback A function that modify the value of the JsonLd.
     * @return {void} Returns null if the operation is successful. Otherwise, it throws an exception.
     * @throws {Error}
     */
