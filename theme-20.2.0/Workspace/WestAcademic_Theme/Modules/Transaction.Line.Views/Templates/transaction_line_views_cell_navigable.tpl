...
<tr class="transaction-line-views-cell-navigable {{cellClassName}} item-{{itemId}}" data-id="{{itemId}}" data-item-type="{{itemType}}">
        ...
        <p class="transaction-line-views-cell-navigable-product-name">
            ...
            {{else}}
                <span class="transaction-line-views-cell-navigable-product-title">
                    {{model.item.custitem_long_title}}
                </span>
            {{/if}}
        </p>
       <!-- {{#unless isFreeGift}}
   ...
   <!-- <td class="transaction-line-views-cell-navigable-item-unit-price" name="item-upc">
        <p>
            <span class="transaction-line-views-cell-navigable-item-unit-price-label">ISBN:</span>
            <span class="transaction-line-views-cell-navigable-item-unit-price-value">{{model.item.upccode}}</span>
        </p>
    </td>-->
    {{#if showBlockDetail2}}
