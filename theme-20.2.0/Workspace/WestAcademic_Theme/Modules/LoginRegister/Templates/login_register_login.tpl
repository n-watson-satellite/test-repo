...
<p class="login-register-login-description">
	{{#unless isSkipLogin}}
		{{translate 'Sign in below to checkout with an existing account and receive free shipping on every order.'}}
	{{/unless}}
</p>
...
<!--		</div>-->
		...
		<div class="login-register-login-form-controls-group" data-type="form-login-action">
			...
			<button type="submit" class="login-register-login-submit" onclick="window.location.href = 'https://signin.westacademic.com/SAML/NetSuiteSSO?isStore=true&ReturnUrl=https://www.westacademic.com';">
				{{translate 'Sign In'}}
			</button>
