...
<!--	<div class="login-register-register-form-messages" data-type="alert-placeholder"></div>-->
	...
	<div class="login-register-register-form-controls-group">
		<button class="login-register-register-form-submit" onclick="window.location.href = 'https://signin.westacademic.com/Registration/WizardStep1?ReturnUrl=https://www.westacademic.com/autoSignIn=true&signInUrl=https://signin.westacademic.com/SAML/NetSuiteSSO?isStore=true';">
