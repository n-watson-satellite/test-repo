<section class="login-register" >
	...
	<header class="login-register-header">
		{{#if showRegister}}
		<h1 class="login-register-title"> {{translate 'Sign in | Register'}}</h1>
		{{else}}
		<h1 class="login-register-title"> {{translate 'Sign in'}}</h1>
		{{/if}}
	</header>
		...
		{{#if showRegisterOrGuest}}
			<div class="login-register-wrapper-column-register">
				<div class="login-register-wrapper-register">
					...
					{{#if showRegister}}
					<div class="" data-view="Register" id="register-view"></div>
					{{/if}}
